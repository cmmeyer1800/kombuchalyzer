...
*/}}
{{- define "kombuchalyzer.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "kombuchalyzer.fullname" .) .Values.serviceAccount.name }}
{{- else }}
